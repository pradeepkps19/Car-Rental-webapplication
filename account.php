...
<body>
	...
	<section class="search">
		...
		<div id="fom">
			<form method="post">
			<h3 style="text-align:center;padding:30px; color: #000099; font-weight:bold; text-decoration:underline">Client Login Area</h3>
				<table height="100" align="center">
					...
					<tr>
						...
						<td style="text-align:right;"><input type="button"  value="signup" /></td>
					</tr>
				</table>
			</form>
			<?php
